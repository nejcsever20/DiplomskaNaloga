...
{
    /// <inheritdoc />
    public partial class Izkladisceno : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Palete = table.Column<int>(type: "int", nullable: false),
                    Skladiscnik = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Datum = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SkladiscnikId = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Izkladisceno", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DolocenSkladiscnikId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_diplomska_Transports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_diplomska_Transports_AspNetUsers_DolocenSkladiscnikId",
                        column: x => x.DolocenSkladiscnikId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_diplomska_Transports_DolocenSkladiscnikId",
                table: "diplomska_Transports",
                column: "DolocenSkladiscnikId");
        }
